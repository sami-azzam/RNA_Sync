...
import {userProfileTemplate} from '../models/types';
...
export default function Profile({user, userData}: any) {
  ...
  const userDataTemplate: userProfileTemplate = {
    displayName: '',
    email: '',
    phoneNumber: '',
    photoURL: '',
  ...
  const [userProfile, setUserProfile] = useState<userProfileTemplate>(userInfo);
    ...
    <ScrollView>
      ...
      <Section title="Personal Details">
        <TextInput
          ...
          onChangeText={text =>
            setUserProfile((prev: any) => ({...prev, displayName: text}))
          }
        />
        <TextInput
          style={$textInput}
      ...
      <Section title="Car Details">
        <TextInput
          style={$textInput}
          placeholder="Emirate"
          value={userProfile.emirate}
          onChangeText={text =>
            setUserProfile(prev => ({...prev, emirate: text}))
          }
        />
        <TextInput
          style={$textInput}
          placeholder="Plate No"
          value={userProfile.plateNo}
          onChangeText={text =>
            setUserProfile(prev => ({...prev, plateNo: text}))
          }
        />
        <TextInput
          style={$textInput}
          placeholder="Car Type"
          value={userProfile.carType}
          onChangeText={text =>
            setUserProfile(prev => ({...prev, carType: text}))
          }
        />
        <TextInput
          style={$textInput}
          placeholder="Car Color"
          value={userProfile.carColor}
          onChangeText={text =>
            setUserProfile(prev => ({...prev, carColor: text}))
          }
        />
      </Section>
